...
{
    /// <summary>葡萄弹（版本 5，银）：4s 小 银 武器；▶ 造成 15 » 30 » 60 伤害；弹药：{AmmoCap}；使用其他弹药物品时，为此物品装填 {Reload} 发（Lst）。</summary>
    public static ItemTemplate Template()
    {
        return new ItemTemplate
        {
            Name = "葡萄弹",
            Desc = "▶ 造成 {Damage} 伤害；弹药：{AmmoCap}；使用其他弹药物品时，为此物品装填 {Reload} 发弹药",
            Tags = Tag.Weapon,
            Cooldown = 4.0,
            Damage = [15, 30, 60],
            AmmoCap = 2,
    ...
    /// <summary>葡萄弹_S1（铜）：4s 小 铜 武器；▶ 造成 20 » 30 » 40 » 50 伤害；弹药：{AmmoCap}；使用其他弹药物品时，为此物品装填 {Reload} 发（Lst）。</summary>
