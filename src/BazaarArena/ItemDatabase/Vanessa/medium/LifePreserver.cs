...
{
    /// <summary>救生圈：7s 中 铜 水系；▶ 获得护盾；即将首次落败时治疗（Immediate），Custom_0=0 时生效、生效后置 1。</summary>
        ...
        return new ItemTemplate
        {
            ...
            [
                ...
                Ability.Heal.Override(
                    ...
                    additionalCondition: Condition.CasterCustom0IsZero & Condition.CasterSideHpLEZero,
