...
# 用法：
#   - 全量测试：在仓库根目录执行 python scripts/run_item_tests_medium_silver.py
#   - 仅重跑上次未通过的用例：python scripts/run_item_tests_medium_silver.py --failed-only
...
DECK_JSON = os.path.join(REPO_ROOT, "Data", "Decks", "test_medium_silver.json")
