...
# 用法：
#   - 全量测试：在仓库根目录执行 python scripts/item_tests/run_item_tests_large_bronze.py
#   - 仅重跑上次未通过的用例：python scripts/item_tests/run_item_tests_large_bronze.py --failed-only
...
DECK_JSON = os.path.join(REPO_ROOT, "Data", "Decks", "item_tests", "test_large_bronze.json")
